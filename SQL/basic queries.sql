...
select * from People l full join CellPhone p on l.CellPhoneID = p.CellPhoneID
select * from People l full join CellPhone p on l.CellPhoneID = p.CellPhoneID where p.CellPhoneID is null or l.PersonID is null -- full excPeopleng join
